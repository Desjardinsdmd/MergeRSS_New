    ...
    <Card className="border-stone-800 bg-stone-900">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-medium text-stone-200 text-sm">Email Notifications</p>
            <p className="text-xs text-stone-500">Receive important updates via email</p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-medium text-stone-200 text-sm">Digest Delivery Alerts</p>
            <p className="text-xs text-stone-500">Get notified when digests are delivered</p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-medium text-stone-200 text-sm">Feed Error Alerts</p>
            <p className="text-xs text-stone-500">Alert when a feed fails to fetch</p>
          </div>
