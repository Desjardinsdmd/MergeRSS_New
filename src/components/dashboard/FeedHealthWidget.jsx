    ...
    <div className="bg-stone-900 border border-stone-800">
      <div className="pb-2 pt-4 px-4 flex flex-row items-center justify-between">
        ...
        <button
          ...
          disabled={refreshing}
          className="text-xs text-stone-500 hover:text-[hsl(var(--primary))] transition-colors flex items-center gap-1 disabled:opacity-50"
        >
      ...
      {feeds.length > 8 && (
        <div className="px-4 py-2 border-t border-stone-800">
          <Link to={createPageUrl('Feeds')} className="text-xs text-stone-500 hover:text-[hsl(var(--primary))] transition-colors">
