                ...
                {newItems.map((item) => {
                    ...
                    return (
                        <div key={item.id} className={[
                            'px-5 py-3.5 hover:bg-stone-800/30 transition-colors',
                            isHigh ? 'border-l-[3px] border-[hsl(var(--primary))]' : '',
                        ].join(' ')}>
                            {/* Decision state + tag */}
                            ...
                            {/* Headline */}
                            <a href={safeUrl(item.url)} target="_blank" rel="noopener noreferrer" className="group flex items-start gap-2 mb-1">
                                <h3 className="text-sm font-semibold text-stone-100 leading-snug group-hover:text-[hsl(var(--primary))] transition-colors line-clamp-1 flex-1">
                            ...
                            {/* Insight */}
                            {insight && (
                                <p className={`text-xs font-medium mb-2 line-clamp-1 ${tagTextClass}`}>↳ {insight}</p>
                            )}
